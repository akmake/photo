...
export const ToolIcons = {
  edit: icon(<><path d="M4 20h4L19 9l-4-4L4 16Z" /><path d="m13.5 6.5 4 4M4 20l1-4" /></>),
  ...
  effects: icon(<><path d="m12 3 1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5Z" /><path d="m18.5 15 .8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8Z" /></>),
  animate: icon(<><path d="M8 5v14l11-7Z" /><path d="M3 5v14" /></>),
  spacing: icon(<><path d="M5 7h14M5 17h14" /><path d="m12 9-2 3h4l-2 3" /></>),
