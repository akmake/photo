...
# מפרט מלא — מערכת סשנים ורצפים מקצועית

## 0. מטרת העבודה

לבנות מחדש את אזור הסשנים/רצפים כך שיהיה כלי עבודה מקצועי לניהול מאות ואלפי תמונות.
...
זה השינוי העקרוני ביותר לעומת `Batches.tsx` הנוכחי, שנבנה סביב רעיון של pool שמצטמצם בזמן יצירת סשנים.
