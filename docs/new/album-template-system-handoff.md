...
6. **קובץ מקור:** התבקשה חבילת אינדיזיין (File ← Package עם Copy Fonts, Copy Linked Graphics, Include IDML). עד שתגיע — עובדים מה־PDF, עמוד אחד ידני.
...
> נסגרו ב־14.09.2026 (ראו 1.1): רישוי — אין בעיה; צבעים — לכל כפולה לפי התמונות; יחס — רק גודל הכספת כרגע; קובץ מקור — התבקש. נותרו פתוחות: אילו טקסטים עריכים ואילו קבועים; personal templates — משתמש או סטודיו.
