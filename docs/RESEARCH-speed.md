...
1. **"הבנה" בייבוא + מסלולים מקבילים שמתאימים את עצמם למחשב** — הבסיס והרווח הגדול. דורש אישור (משנה איך המנוע עובד).
2. **שמירת תוצאה אחרי שלבי הפנים** — עריכת צבע מיידית.
3. **מדידה פנימית של ניקוי הכתמים** — ואז מסננים מהירים / עבודה בקטן, רק עם בדיקת התאמה.
